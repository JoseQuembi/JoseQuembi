<div id="application-sidebar" class="hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-hide lg:block lg:translate-x-0 lg:right-auto lg:bottom-0 dark:bg-gray-800 dark:border-gray-700">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('admin.dashboard') ? 'bg-gray-100 text-blue-600 dark:text-gray-800 dark:hover:text-gray-100' : 'text-slate-700 hover:bg-gray-100' }} text-sm rounded-md dark:hover:bg-gray-900 dark:text-white" href="{{ route('admin.dashboard') }}">
            ...
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('admin.chart') ? 'bg-gray-100 text-blue-600 dark:text-gray-800 dark:hover:text-gray-100' : 'text-slate-700 hover:bg-gray-100' }} text-sm rounded-md dark:hover:bg-gray-900 dark:text-white" href="{{ route('admin.chart') }}">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('admin.resources.*') ? 'bg-gray-100 text-blue-600 dark:text-gray-800 dark:hover:text-gray-100' : 'text-slate-700 hover:bg-gray-100' }} text-sm rounded-md dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.resources.index') }}">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @role('admin')
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('admin.settings.*') ? 'bg-gray-100 text-blue-600 dark:text-gray-800 dark:hover:text-gray-100' : 'text-slate-700 hover:bg-gray-100' }} text-sm rounded-md dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.settings.index') }}">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @endrole
            <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('admin.profile.*') ? 'bg-gray-100 text-blue-600 dark:text-gray-800 dark:hover:text-gray-100' : 'text-slate-700 hover:bg-gray-100' }} text-sm rounded-md dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.profile.show') }}">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            @endrole
            <li class="hs-accordion" id="milestones-accordion">
                <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href="javascript:;">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="milestones-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="pt-2 pl-2">
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.milestones.index') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.milestones.index') }}">
                                Lista de Milestones
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.milestones.create') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.milestones.create') }}">
                                Criar Milestone
                            </a>
                        </li>
                    </ul>
            ...
            <li class="hs-accordion" id="issues-accordion">
                <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href="javascript:;">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div id="issues-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="pt-2 pl-2">
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.issues.index') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.issues.index') }}">
                                Lista de Issues
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.issues.create') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.issues.create') }}">
                                Criar Issue
                            </a>
                        </li>
                    </ul>
            ...
            <li class="hs-accordion" id="teams-accordion">
                <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href="javascript:;">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                    </svg>
                ...
                <div id="teams-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="pt-2 pl-2">
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.teams.index') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.teams.index') }}">
                                Lista de Equipes
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.teams.create') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.teams.create') }}">
                                Criar Equipe
                            </a>
                        </li>
                    </ul>
            ...
            <li class="hs-accordion" id="risks-accordion">
                <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-900 dark:text-slate-400 dark:hover:text-slate-300 dark:hs-accordion-active:text-white" href="javascript:;">
                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" />
                    </svg>
                ...
                <div id="risks-accordion-child" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
                    <ul class="pt-2 pl-2">
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.risks.index') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.risks.index') }}">
                                Lista de Riscos
                            </a>
                        </li>
                        <li>
                            <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm {{ request()->routeIs('admin.risks.create') ? 'text-blue-600' : 'text-slate-700 hover:bg-gray-100' }} rounded-md dark:bg-gray-800 dark:text-slate-400 dark:hover:text-slate-300" href="{{ route('admin.risks.create') }}">
                                Criar Risco
                            </a>
                        </li>
                    </ul>
