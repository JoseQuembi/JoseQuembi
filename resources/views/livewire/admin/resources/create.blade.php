    ...
    <div class="px-4 py-6 sm:px-0">
        ...
        <form wire:submit.prevent="save" class="mt-6 space-y-6">
            ...
            <div>
                ...
                <select wire:model="type" id="type" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
            ...
            <div>
                ...
                <select wire:model="project_id" id="project" class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm rounded-md">
