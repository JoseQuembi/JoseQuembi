<div class="p-6 bg-white rounded-lg shadow-lg">
    ...
    <form wire:submit.prevent="createProject">
        ...
        <div class="mb-4">
            <select wire:model="client_id" type="text" id="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
