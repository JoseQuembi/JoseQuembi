<div class="p-6 bg-white rounded-lg shadow-lg">
    ...
    <form wire:submit.prevent="createProject">
        ...
        <div class="mb-4">
            <label for="type" class="block text-gray-700 text-sm font-bold mb-2">Tipo do Projeto</label>
        ...
        <div class="mb-4">
            ...
            <select wire:model="client_id" id="client_id" data-hs-select='{
                ...
                <option value="{{ $client->id }}" ata-hs-select-option='{
                        "icon": "<img class=\"shrink-0 size-5 rounded-full\" src=\"{{ asset('img/default/user.png') }}\" alt=\"{{ $client->name }}\" />"}'>
                    {{ $client->name }}
                </option>
                @endforeach
            </select>
        ...
        <div class="mb-4">
            <label for="status" class="block text-gray-700 text-sm font-bold mb-2">Status do Projeto</label>
            <select wire:model="status" data-hs-select='{
                ...
                <option value="Em progesso">Em Progreeso</option>
        ...
        <div class="mb-4">
            ...
            <input wire:model="progress" type="number" id="progress" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" min="0" max="100">
