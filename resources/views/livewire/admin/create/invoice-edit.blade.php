    ...
    <form wire:submit.prevent="updateInvoice" class="space-y-6">
        ...
        <div class="grid grid-cols-3 gap-6">
            <div>
                ...
                <input type="text" id="invoice_number" wire:model="invoice_number" class="px-3 py-2 mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
